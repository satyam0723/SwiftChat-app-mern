...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    if (userInfo.image) {
      console.log("Image value from userInfo.image:", userInfo.image);
        ...
        <div className="grid grid-cols-2">
          ...
          >
            ...
            <input
              type="file"
              ref={fileInputRef}
              className="hidden border border-red-600"
              onChange={handleImageChange}
              name="profile-image"
              accept=".png, .jpeg, .jpg, .svg, .webp"
            />
          </div>
          <div className="min-w-32 md:min-w-64 flex flex-col gap-5 text-white items-center justify-center">
